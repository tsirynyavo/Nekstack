          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div>
              ...
              <p className="text-gray-400 text-sm flex items-center gap-2 flex-wrap">
                <span>
                  Bienvenue, {user?.email?.split("@")[0] || "Champion"}
                </span>
            ...
            <div className="flex items-center gap-3 flex-wrap justify-center">
              <div className="glass-white rounded-xl px-4 py-2">
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-cyan-400 font-mono text-xl tracking-wider">
            ...
            >
              <GlassCard className="p-5">
                <div className="flex items-start justify-between">
                  <div
                    className={`p-3 rounded-xl bg-gradient-to-br from-${stat.color}-500/10 to-${stat.color}-600/5`}
                  >
          ...
          <GlassCard>
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center p-3 bg-gray-800/30 rounded-xl">
                ...
                <span
                  className={`font-mono text-sm flex items-center gap-1 ${wsConnected ? "text-green-400" : "text-red-400"}`}
                >
                  <div
              ...
              <div className="flex justify-between items-center p-3 bg-gray-800/30 rounded-xl">
                ...
                <span className="text-white font-mono text-sm">
                  {Math.floor((data?.systemHealth?.uptime || 86400) / 3600)}h{" "}
                  {Math.floor(
                    ((data?.systemHealth?.uptime || 86400) % 3600) / 60,
                  )}
                  m
                </span>
              </div>
